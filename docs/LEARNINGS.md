...
- **2026-03-30 (task 037):** The synthetic-review `push` harness must treat "no open PR for this branch" as an expected skip, not a failed run. Otherwise commit-message-tagged test pushes generate red Actions noise outside an active PR workflow.
